...
Follow EBCS, IEC 60364, IEC 60529, EEU connection requirements, and IEC 60617 symbols. Ethiopian supply assumptions: 220-230V single-phase, 380-400V three-phase, 50Hz. Use IEC/EU equipment language: DIN-rail MCB/RCBO/RCCB, Type F/Schuko-style earthed socket outlets where appropriate, copper conductors sized in mm2, PVC conduit/trunking, IP-rated fittings for wet/outdoor areas. Do not use US-only terminology such as AWG, receptacle yokes, 120/240V split phase, NEMA outlets, or NEC article references. Lighting minimums: offices 500 lux, corridors 100 lux, bathrooms 200 lux, kitchens 300 lux, parking 75 lux, stairs 150 lux.
